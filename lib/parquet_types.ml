...
module EdgeInterpolationAlgorithm = struct
  type t = SPHERICAL | VINCENTY | THOMAS | ANDOYER | KARNEY
...
class sizeStatistics =
  object (self)
    ...
    method get_unencoded_byte_array_data_bytes =
      _unencoded_byte_array_data_bytes

    method grab_unencoded_byte_array_data_bytes =
      match _unencoded_byte_array_data_bytes with
      | None ->
          raise (Field_empty "sizeStatistics.unencoded_byte_array_data_bytes")
      | Some _x0 -> _x0

    method set_unencoded_byte_array_data_bytes _x0 =
      _unencoded_byte_array_data_bytes <- Some _x0

    method unset_unencoded_byte_array_data_bytes =
      _unencoded_byte_array_data_bytes <- None

    method reset_unencoded_byte_array_data_bytes =
      _unencoded_byte_array_data_bytes <- None
    ...
    method grab_repetition_level_histogram =
      match _repetition_level_histogram with
      | None -> raise (Field_empty "sizeStatistics.repetition_level_histogram")
      | Some _x1 -> _x1

    method set_repetition_level_histogram _x1 =
      _repetition_level_histogram <- Some _x1

    method unset_repetition_level_histogram =
      _repetition_level_histogram <- None

    method reset_repetition_level_histogram =
      _repetition_level_histogram <- None
    ...
    method grab_definition_level_histogram =
      match _definition_level_histogram with
      | None -> raise (Field_empty "sizeStatistics.definition_level_histogram")
      | Some _x2 -> _x2

    method set_definition_level_histogram _x2 =
      _definition_level_histogram <- Some _x2

    method unset_definition_level_histogram =
      _definition_level_histogram <- None

    method reset_definition_level_histogram =
      _definition_level_histogram <- None
    ...
    method write (oprot : Protocol.t) =
      ...
      | Some _v ->
          oprot#writeFieldBegin
            ("unencoded_byte_array_data_bytes", Protocol.T_I64, 1);
          oprot#writeI64 _v;
          oprot#writeFieldEnd);
      (match _repetition_level_histogram with
      | None -> ()
      | Some _v ->
          oprot#writeFieldBegin
            ("repetition_level_histogram", Protocol.T_LIST, 2);
          oprot#writeListBegin (Protocol.T_I64, List.length _v);
          List.iter (fun _iter5 -> oprot#writeI64 _iter5) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _definition_level_histogram with
      | None -> ()
      | Some _v ->
          oprot#writeFieldBegin
            ("definition_level_histogram", Protocol.T_LIST, 3);
          oprot#writeListBegin (Protocol.T_I64, List.length _v);
          List.iter (fun _iter6 -> oprot#writeI64 _iter6) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
...
let rec read_sizeStatistics (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t8 = Protocol.T_STOP then raise Break else ();
       (match _id9 with
       | 1 ->
           if _t8 = Protocol.T_I64 then
             _str7#set_unencoded_byte_array_data_bytes iprot#readI64
           else iprot#skip _t8
       | 2 ->
           if _t8 = Protocol.T_LIST then
             _str7#set_repetition_level_histogram
               (let _etype13, _size10 = iprot#readListBegin in
                let _con14 =
                  Array.to_list (Array.init _size10 (fun _ -> iprot#readI64))
                in
                iprot#readListEnd;
                _con14)
           else iprot#skip _t8
           ...
           if _t8 = Protocol.T_LIST then
             _str7#set_definition_level_histogram
               (let _etype18, _size15 = iprot#readListBegin in
                let _con19 =
                  Array.to_list (Array.init _size15 (fun _ -> iprot#readI64))
                in
                iprot#readListEnd;
                _con19)
           else iprot#skip _t8
...
class boundingBox =
  object (self)
    ...
    method grab_xmin =
      match _xmin with
      | None -> raise (Field_empty "boundingBox.xmin")
      | Some _x21 -> _x21
    ...
    method grab_xmax =
      match _xmax with
      | None -> raise (Field_empty "boundingBox.xmax")
      | Some _x22 -> _x22
    ...
    method grab_ymin =
      match _ymin with
      | None -> raise (Field_empty "boundingBox.ymin")
      | Some _x23 -> _x23
    ...
    method grab_ymax =
      match _ymax with
      | None -> raise (Field_empty "boundingBox.ymax")
      | Some _x24 -> _x24
    ...
    method grab_zmin =
      match _zmin with
      | None -> raise (Field_empty "boundingBox.zmin")
      | Some _x25 -> _x25
    ...
    method grab_zmax =
      match _zmax with
      | None -> raise (Field_empty "boundingBox.zmax")
      | Some _x26 -> _x26
    ...
    method grab_mmin =
      match _mmin with
      | None -> raise (Field_empty "boundingBox.mmin")
      | Some _x27 -> _x27
    ...
    method grab_mmax =
      match _mmax with
      | None -> raise (Field_empty "boundingBox.mmax")
      | Some _x28 -> _x28
...
let rec read_boundingBox (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t32 = Protocol.T_STOP then raise Break else ();
       (match _id33 with
       | 1 ->
           if _t32 = Protocol.T_DOUBLE then _str31#set_xmin iprot#readDouble
           else iprot#skip _t32
       | 2 ->
           if _t32 = Protocol.T_DOUBLE then _str31#set_xmax iprot#readDouble
           else iprot#skip _t32
       | 3 ->
           if _t32 = Protocol.T_DOUBLE then _str31#set_ymin iprot#readDouble
           else iprot#skip _t32
       | 4 ->
           if _t32 = Protocol.T_DOUBLE then _str31#set_ymax iprot#readDouble
           else iprot#skip _t32
       | 5 ->
           if _t32 = Protocol.T_DOUBLE then _str31#set_zmin iprot#readDouble
           else iprot#skip _t32
       | 6 ->
           if _t32 = Protocol.T_DOUBLE then _str31#set_zmax iprot#readDouble
           else iprot#skip _t32
       | 7 ->
           if _t32 = Protocol.T_DOUBLE then _str31#set_mmin iprot#readDouble
           else iprot#skip _t32
       | 8 ->
           if _t32 = Protocol.T_DOUBLE then _str31#set_mmax iprot#readDouble
           else iprot#skip _t32
       | _ -> iprot#skip _t32);
       iprot#readFieldEnd
     done;
...
class geospatialStatistics =
  object (self)
    ...
    method grab_bbox =
      match _bbox with
      | None -> raise (Field_empty "geospatialStatistics.bbox")
      | Some _x35 -> _x35
    ...
    method grab_geospatial_types =
      match _geospatial_types with
      | None -> raise (Field_empty "geospatialStatistics.geospatial_types")
      | Some _x36 -> _x36
    ...
    method copy =
      let _new = Oo.copy self in
      if _bbox <> None then _new#set_bbox self#grab_bbox#copy;
      _new
    ...
    method write (oprot : Protocol.t) =
      ...
      | Some _v ->
          ...
          List.iter (fun _iter39 -> oprot#writeI32 _iter39) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      oprot#writeFieldStop;
      oprot#writeStructEnd
...
let rec read_geospatialStatistics (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t41 = Protocol.T_STOP then raise Break else ();
       (match _id42 with
       | 1 ->
           if _t41 = Protocol.T_STRUCT then
             _str40#set_bbox (read_boundingBox iprot)
           else iprot#skip _t41
       | 2 ->
           if _t41 = Protocol.T_LIST then
             _str40#set_geospatial_types
               (let _etype46, _size43 = iprot#readListBegin in
                let _con47 =
                  Array.to_list (Array.init _size43 (fun _ -> iprot#readI32))
                in
                iprot#readListEnd;
                _con47)
           else iprot#skip _t41
...
class statistics =
  object (self)
    ...
    method grab_is_max_value_exact =
      match _is_max_value_exact with
      | None -> raise (Field_empty "statistics.is_max_value_exact")
      | Some _x55 -> _x55
    ...
    method grab_is_min_value_exact =
      match _is_min_value_exact with
      | None -> raise (Field_empty "statistics.is_min_value_exact")
      | Some _x56 -> _x56
...
let rec read_statistics (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t60 = Protocol.T_STOP then raise Break else ();
       (match _id61 with
       | 1 ->
           if _t60 = Protocol.T_STRING then _str59#set_max iprot#readString
           else iprot#skip _t60
       | 2 ->
           if _t60 = Protocol.T_STRING then _str59#set_min iprot#readString
           else iprot#skip _t60
       | 3 ->
           if _t60 = Protocol.T_I64 then _str59#set_null_count iprot#readI64
           else iprot#skip _t60
       | 4 ->
           if _t60 = Protocol.T_I64 then _str59#set_distinct_count iprot#readI64
           else iprot#skip _t60
       | 5 ->
           if _t60 = Protocol.T_STRING then
...
let rec read_stringType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t66 = Protocol.T_STOP then raise Break else ();
       (match _id67 with _ -> iprot#skip _t66);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_uUIDType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t72 = Protocol.T_STOP then raise Break else ();
       (match _id73 with _ -> iprot#skip _t72);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_mapType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t78 = Protocol.T_STOP then raise Break else ();
       (match _id79 with _ -> iprot#skip _t78);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_listType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t84 = Protocol.T_STOP then raise Break else ();
       (match _id85 with _ -> iprot#skip _t84);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_enumType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t90 = Protocol.T_STOP then raise Break else ();
       (match _id91 with _ -> iprot#skip _t90);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_dateType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t96 = Protocol.T_STOP then raise Break else ();
       (match _id97 with _ -> iprot#skip _t96);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_float16Type (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       (match _id103 with _ -> iprot#skip _t102);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_nullType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t108 = Protocol.T_STOP then raise Break else ();
       (match _id109 with _ -> iprot#skip _t108);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_decimalType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       (match _id117 with
       | 1 ->
           if _t116 = Protocol.T_I32 then _str115#set_scale iprot#readI32
           else iprot#skip _t116
       | 2 ->
           if _t116 = Protocol.T_I32 then _str115#set_precision iprot#readI32
           else iprot#skip _t116
       | _ -> iprot#skip _t116);
       iprot#readFieldEnd
     done;
...
let rec read_microSeconds (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t128 = Protocol.T_STOP then raise Break else ();
       (match _id129 with _ -> iprot#skip _t128);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_nanoSeconds (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t134 = Protocol.T_STOP then raise Break else ();
       (match _id135 with _ -> iprot#skip _t134);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_timeUnit (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t143 = Protocol.T_STOP then raise Break else ();
       (match _id144 with
       | 1 ->
           if _t143 = Protocol.T_STRUCT then
             _str142#set_mILLIS (read_milliSeconds iprot)
           else iprot#skip _t143
       | 2 ->
           if _t143 = Protocol.T_STRUCT then
...
let rec read_timestampType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t151 = Protocol.T_STOP then raise Break else ();
       (match _id152 with
       | 1 ->
           if _t151 = Protocol.T_BOOL then
             _str150#set_isAdjustedToUTC iprot#readBool
           else iprot#skip _t151
       | 2 ->
           if _t151 = Protocol.T_STRUCT then
...
let rec read_timeType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t159 = Protocol.T_STOP then raise Break else ();
       (match _id160 with
       | 1 ->
           if _t159 = Protocol.T_BOOL then
             _str158#set_isAdjustedToUTC iprot#readBool
           else iprot#skip _t159
       | 2 ->
           if _t159 = Protocol.T_STRUCT then
...
let rec read_intType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t167 = Protocol.T_STOP then raise Break else ();
       (match _id168 with
       | 1 ->
           if _t167 = Protocol.T_BYTE then _str166#set_bitWidth iprot#readByte
           else iprot#skip _t167
       | 2 ->
           if _t167 = Protocol.T_BOOL then _str166#set_isSigned iprot#readBool
           else iprot#skip _t167
       | _ -> iprot#skip _t167);
       iprot#readFieldEnd
     done;
...
let rec read_jsonType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t173 = Protocol.T_STOP then raise Break else ();
       (match _id174 with _ -> iprot#skip _t173);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_bsonType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t179 = Protocol.T_STOP then raise Break else ();
       (match _id180 with _ -> iprot#skip _t179);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
class variantType =
  object (self)
    ...
    method grab_specification_version =
      match _specification_version with
      | None -> raise (Field_empty "variantType.specification_version")
      | Some _x182 -> _x182

    method set_specification_version _x182 =
      _specification_version <- Some _x182
...
let rec read_variantType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t186 = Protocol.T_STOP then raise Break else ();
       (match _id187 with
       | 1 ->
           if _t186 = Protocol.T_BYTE then
             _str185#set_specification_version iprot#readByte
           else iprot#skip _t186
       | _ -> iprot#skip _t186);
       iprot#readFieldEnd
     done;
     ()
...
class geometryType =
  object (self)
    ...
    method grab_crs =
      match _crs with
      | None -> raise (Field_empty "geometryType.crs")
      | Some _x189 -> _x189
...
let rec read_geometryType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t193 = Protocol.T_STOP then raise Break else ();
       (match _id194 with
       | 1 ->
           if _t193 = Protocol.T_STRING then _str192#set_crs iprot#readString
           else iprot#skip _t193
       | _ -> iprot#skip _t193);
       iprot#readFieldEnd
     done;
     ()
...
class geographyType =
  object (self)
    ...
    method grab_crs =
      match _crs with
      | None -> raise (Field_empty "geographyType.crs")
      | Some _x196 -> _x196
    ...
    method grab_algorithm =
      ...
      | None -> raise (Field_empty "geographyType.algorithm")
      | Some _x197 -> _x197
...
let rec read_geographyType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t201 = Protocol.T_STOP then raise Break else ();
       (match _id202 with
       | 1 ->
           if _t201 = Protocol.T_STRING then _str200#set_crs iprot#readString
           else iprot#skip _t201
       | 2 ->
           if _t201 = Protocol.T_I32 then
             _str200#set_algorithm
               (EdgeInterpolationAlgorithm.of_i iprot#readI32)
           else iprot#skip _t201
       | _ -> iprot#skip _t201);
       iprot#readFieldEnd
     done;
...
class logicalType =
  object (self)
    ...
    method grab_fLOAT16 =
      match _fLOAT16 with
      | None -> raise (Field_empty "logicalType.fLOAT16")
      | Some _x217 -> _x217
    ...
    method grab_vARIANT =
      match _vARIANT with
      | None -> raise (Field_empty "logicalType.vARIANT")
      | Some _x218 -> _x218
    ...
    method grab_gEOMETRY =
      match _gEOMETRY with
      | None -> raise (Field_empty "logicalType.gEOMETRY")
      | Some _x219 -> _x219
    ...
    method grab_gEOGRAPHY =
      match _gEOGRAPHY with
      | None -> raise (Field_empty "logicalType.gEOGRAPHY")
      | Some _x220 -> _x220
    ...
    method copy =
      ...
      if _fLOAT16 <> None then _new#set_fLOAT16 self#grab_fLOAT16#copy;
      if _vARIANT <> None then _new#set_vARIANT self#grab_vARIANT#copy;
      if _gEOMETRY <> None then _new#set_gEOMETRY self#grab_gEOMETRY#copy;
      if _gEOGRAPHY <> None then _new#set_gEOGRAPHY self#grab_gEOGRAPHY#copy;
      _new
...
let rec read_logicalType (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t224 = Protocol.T_STOP then raise Break else ();
       (match _id225 with
       | 1 ->
           if _t224 = Protocol.T_STRUCT then
             _str223#set_sTRING (read_stringType iprot)
           else iprot#skip _t224
       | 2 ->
           if _t224 = Protocol.T_STRUCT then
...
let rec read_schemaElement (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t240 = Protocol.T_STOP then raise Break else ();
       (match _id241 with
       | 1 ->
           if _t240 = Protocol.T_I32 then
             _str239#set_type (Type.of_i iprot#readI32)
           else iprot#skip _t240
       | 2 ->
           if _t240 = Protocol.T_I32 then _str239#set_type_length iprot#readI32
           else iprot#skip _t240
       | 3 ->
           if _t240 = Protocol.T_I32 then
             _str239#set_repetition_type
               (FieldRepetitionType.of_i iprot#readI32)
           else iprot#skip _t240
       | 4 ->
           if _t240 = Protocol.T_STRING then _str239#set_name iprot#readString
           else iprot#skip _t240
       | 5 ->
           if _t240 = Protocol.T_I32 then _str239#set_num_children iprot#readI32
           else iprot#skip _t240
       | 6 ->
           if _t240 = Protocol.T_I32 then
       ...
       | 7 ->
           if _t240 = Protocol.T_I32 then _str239#set_scale iprot#readI32
           else iprot#skip _t240
       | 8 ->
           if _t240 = Protocol.T_I32 then _str239#set_precision iprot#readI32
           else iprot#skip _t240
       | 9 ->
           if _t240 = Protocol.T_I32 then _str239#set_field_id iprot#readI32
           else iprot#skip _t240
       | 10 ->
           if _t240 = Protocol.T_STRUCT then
...
class dataPageHeader =
  object (self)
    ...
    method set_definition_level_encoding _x245 =
      _definition_level_encoding <- Some _x245
    ...
    method set_repetition_level_encoding _x246 =
      _repetition_level_encoding <- Some _x246
...
let rec read_dataPageHeader (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t251 = Protocol.T_STOP then raise Break else ();
       (match _id252 with
       | 1 ->
           if _t251 = Protocol.T_I32 then _str250#set_num_values iprot#readI32
           else iprot#skip _t251
       | 2 ->
           if _t251 = Protocol.T_I32 then
       ...
       | 5 ->
           if _t251 = Protocol.T_STRUCT then
...
let rec read_indexPageHeader (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t257 = Protocol.T_STOP then raise Break else ();
       (match _id258 with _ -> iprot#skip _t257);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_dictionaryPageHeader (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t266 = Protocol.T_STOP then raise Break else ();
       (match _id267 with
       | 1 ->
           if _t266 = Protocol.T_I32 then _str265#set_num_values iprot#readI32
           else iprot#skip _t266
       | 2 ->
           if _t266 = Protocol.T_I32 then
             _str265#set_encoding (Encoding.of_i iprot#readI32)
           else iprot#skip _t266
       | 3 ->
           if _t266 = Protocol.T_BOOL then _str265#set_is_sorted iprot#readBool
           else iprot#skip _t266
       | _ -> iprot#skip _t266);
       iprot#readFieldEnd
     done;
...
class dataPageHeaderV2 =
  object (self)
    ...
    method set_definition_levels_byte_length _x273 =
      _definition_levels_byte_length <- Some _x273
    ...
    method set_repetition_levels_byte_length _x274 =
      _repetition_levels_byte_length <- Some _x274
...
let rec read_dataPageHeaderV2 (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t280 = Protocol.T_STOP then raise Break else ();
       (match _id281 with
       | 1 ->
           if _t280 = Protocol.T_I32 then _str279#set_num_values iprot#readI32
           else iprot#skip _t280
       | 2 ->
           if _t280 = Protocol.T_I32 then _str279#set_num_nulls iprot#readI32
           else iprot#skip _t280
       | 3 ->
           if _t280 = Protocol.T_I32 then _str279#set_num_rows iprot#readI32
           else iprot#skip _t280
       | 4 ->
           if _t280 = Protocol.T_I32 then
       ...
       | 7 ->
           if _t280 = Protocol.T_BOOL then
             _str279#set_is_compressed iprot#readBool
           else iprot#skip _t280
       | 8 ->
           if _t280 = Protocol.T_STRUCT then
...
let rec read_splitBlockAlgorithm (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       (match _id287 with _ -> iprot#skip _t286);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_bloomFilterAlgorithm (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t293 = Protocol.T_STOP then raise Break else ();
       (match _id294 with
       | 1 ->
           if _t293 = Protocol.T_STRUCT then
             _str292#set_bLOCK (read_splitBlockAlgorithm iprot)
           else iprot#skip _t293
       | _ -> iprot#skip _t293);
       iprot#readFieldEnd
     done;
     ()
...
let rec read_xxHash (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t299 = Protocol.T_STOP then raise Break else ();
       (match _id300 with _ -> iprot#skip _t299);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_bloomFilterHash (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t306 = Protocol.T_STOP then raise Break else ();
       (match _id307 with
       | 1 ->
           if _t306 = Protocol.T_STRUCT then
             _str305#set_xXHASH (read_xxHash iprot)
           else iprot#skip _t306
       | _ -> iprot#skip _t306);
       iprot#readFieldEnd
     done;
     ()
...
let rec read_uncompressed (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t312 = Protocol.T_STOP then raise Break else ();
       (match _id313 with _ -> iprot#skip _t312);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_bloomFilterCompression (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t319 = Protocol.T_STOP then raise Break else ();
       (match _id320 with
       | 1 ->
           if _t319 = Protocol.T_STRUCT then
             _str318#set_uNCOMPRESSED (read_uncompressed iprot)
           else iprot#skip _t319
       | _ -> iprot#skip _t319);
       iprot#readFieldEnd
     done;
     ()
...
let rec read_bloomFilterHeader (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t329 = Protocol.T_STOP then raise Break else ();
       (match _id330 with
       | 1 ->
           if _t329 = Protocol.T_I32 then _str328#set_numBytes iprot#readI32
           else iprot#skip _t329
       | 2 ->
           if _t329 = Protocol.T_STRUCT then
...
class pageHeader =
  object (self)
    ...
    method set_uncompressed_page_size _x333 =
      _uncompressed_page_size <- Some _x333
    ...
    method set_dictionary_page_header _x338 =
      _dictionary_page_header <- Some _x338
...
let rec read_pageHeader (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t343 = Protocol.T_STOP then raise Break else ();
       (match _id344 with
       | 1 ->
           if _t343 = Protocol.T_I32 then
             _str342#set_type (PageType.of_i iprot#readI32)
           else iprot#skip _t343
       | 2 ->
           if _t343 = Protocol.T_I32 then
       ...
       | 4 ->
           if _t343 = Protocol.T_I32 then _str342#set_crc iprot#readI32
           else iprot#skip _t343
       | 5 ->
           if _t343 = Protocol.T_STRUCT then
       ...
       | 7 ->
           if _t343 = Protocol.T_STRUCT then
             _str342#set_dictionary_page_header
...
let rec read_keyValue (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t351 = Protocol.T_STOP then raise Break else ();
       (match _id352 with
       | 1 ->
           if _t351 = Protocol.T_STRING then _str350#set_key iprot#readString
           else iprot#skip _t351
       | 2 ->
           if _t351 = Protocol.T_STRING then _str350#set_value iprot#readString
           else iprot#skip _t351
       | _ -> iprot#skip _t351);
       iprot#readFieldEnd
     done;
...
let rec read_sortingColumn (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t360 = Protocol.T_STOP then raise Break else ();
       (match _id361 with
       | 1 ->
           if _t360 = Protocol.T_I32 then _str359#set_column_idx iprot#readI32
           else iprot#skip _t360
       | 2 ->
           if _t360 = Protocol.T_BOOL then _str359#set_descending iprot#readBool
           else iprot#skip _t360
       | 3 ->
           if _t360 = Protocol.T_BOOL then
...
let rec read_pageEncodingStats (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t369 = Protocol.T_STOP then raise Break else ();
       (match _id370 with
       | 1 ->
           if _t369 = Protocol.T_I32 then
             _str368#set_page_type (PageType.of_i iprot#readI32)
           else iprot#skip _t369
       | 2 ->
           if _t369 = Protocol.T_I32 then
             _str368#set_encoding (Encoding.of_i iprot#readI32)
           else iprot#skip _t369
       | 3 ->
           if _t369 = Protocol.T_I32 then _str368#set_count iprot#readI32
           else iprot#skip _t369
       | _ -> iprot#skip _t369);
       iprot#readFieldEnd
     done;
...
class columnMetaData =
  object (self)
    ...
    method set_total_uncompressed_size _x377 =
      _total_uncompressed_size <- Some _x377
    ...
    method set_total_compressed_size _x378 =
      _total_compressed_size <- Some _x378
    ...
    method set_dictionary_page_offset _x382 =
      _dictionary_page_offset <- Some _x382
    ...
    method grab_size_statistics =
      match _size_statistics with
      | None -> raise (Field_empty "columnMetaData.size_statistics")
      | Some _x387 -> _x387
    ...
    method grab_geospatial_statistics =
      match _geospatial_statistics with
      | None -> raise (Field_empty "columnMetaData.geospatial_statistics")
      | Some _x388 -> _x388

    method set_geospatial_statistics _x388 =
      _geospatial_statistics <- Some _x388
    ...
    method write (oprot : Protocol.t) =
      ...
      | Some _v ->
          ...
          oprot#writeListBegin (Protocol.T_I32, List.length _v);
          List.iter (fun _iter391 -> oprot#writeI32 (Encoding.to_i _iter391)) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _path_in_schema with
      ...
      | Some _v ->
          ...
          List.iter (fun _iter392 -> oprot#writeString _iter392) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _codec with
      ...
      | Some _v ->
          ...
          List.iter (fun _iter393 -> _iter393#write oprot) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _data_page_offset with
      ...
      | Some _v ->
          ...
          oprot#writeListBegin (Protocol.T_STRUCT, List.length _v);
          List.iter (fun _iter394 -> _iter394#write oprot) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _bloom_filter_offset with
      | None -> ()
...
let rec read_columnMetaData (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t396 = Protocol.T_STOP then raise Break else ();
       (match _id397 with
       | 1 ->
           if _t396 = Protocol.T_I32 then
             _str395#set_type (Type.of_i iprot#readI32)
           else iprot#skip _t396
       | 2 ->
           if _t396 = Protocol.T_LIST then
             _str395#set_encodings
               (let _etype401, _size398 = iprot#readListBegin in
                let _con402 =
                  Array.to_list
                    (Array.init _size398 (fun _ -> Encoding.of_i iprot#readI32))
                in
                iprot#readListEnd;
                _con402)
           else iprot#skip _t396
           ...
           if _t396 = Protocol.T_LIST then
             _str395#set_path_in_schema
               (let _etype406, _size403 = iprot#readListBegin in
                let _con407 =
                  Array.to_list
                    (Array.init _size403 (fun _ -> iprot#readString))
                in
                iprot#readListEnd;
                _con407)
           else iprot#skip _t396
       ...
       | 5 ->
           if _t396 = Protocol.T_I64 then _str395#set_num_values iprot#readI64
           else iprot#skip _t396
       | 6 ->
           if _t396 = Protocol.T_I64 then
           ...
           if _t396 = Protocol.T_LIST then
             _str395#set_key_value_metadata
               (let _etype411, _size408 = iprot#readListBegin in
                let _con412 =
                  Array.to_list
                    (Array.init _size408 (fun _ -> read_keyValue iprot))
                in
                iprot#readListEnd;
                _con412)
           else iprot#skip _t396
       ...
       | 12 ->
           if _t396 = Protocol.T_STRUCT then
           ...
           if _t396 = Protocol.T_LIST then
             _str395#set_encoding_stats
               (let _etype416, _size413 = iprot#readListBegin in
                let _con417 =
                  Array.to_list
                    (Array.init _size413 (fun _ -> read_pageEncodingStats iprot))
                in
                iprot#readListEnd;
                _con417)
           else iprot#skip _t396
...
let rec read_encryptionWithFooterKey (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t422 = Protocol.T_STOP then raise Break else ();
       (match _id423 with _ -> iprot#skip _t422);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
  ...
  object (self)
    ...
    method write (oprot : Protocol.t) =
      ...
      | Some _v ->
          ...
          oprot#writeListBegin (Protocol.T_STRING, List.length _v);
          List.iter (fun _iter429 -> oprot#writeString _iter429) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _key_metadata with
      | None -> ()
...
let rec read_encryptionWithColumnKey (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t431 = Protocol.T_STOP then raise Break else ();
       (match _id432 with
       | 1 ->
           if _t431 = Protocol.T_LIST then
             _str430#set_path_in_schema
               (let _etype436, _size433 = iprot#readListBegin in
                let _con437 =
                  Array.to_list
                    (Array.init _size433 (fun _ -> iprot#readString))
                in
                iprot#readListEnd;
                _con437)
           else iprot#skip _t431
       | 2 ->
           if _t431 = Protocol.T_STRING then
...
class columnCryptoMetaData =
  object (self)
    ...
    method set_eNCRYPTION_WITH_FOOTER_KEY _x439 =
      _eNCRYPTION_WITH_FOOTER_KEY <- Some _x439
    ...
    method set_eNCRYPTION_WITH_COLUMN_KEY _x440 =
      _eNCRYPTION_WITH_COLUMN_KEY <- Some _x440
...
let rec read_columnCryptoMetaData (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t444 = Protocol.T_STOP then raise Break else ();
       (match _id445 with
       | 1 ->
           if _t444 = Protocol.T_STRUCT then
             _str443#set_eNCRYPTION_WITH_FOOTER_KEY
               (read_encryptionWithFooterKey iprot)
           else iprot#skip _t444
       | 2 ->
           if _t444 = Protocol.T_STRUCT then
             _str443#set_eNCRYPTION_WITH_COLUMN_KEY
...
class columnChunk =
  object (self)
    ...
    method set_encrypted_column_metadata _x455 =
      _encrypted_column_metadata <- Some _x455
...
let rec read_columnChunk (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t459 = Protocol.T_STOP then raise Break else ();
       (match _id460 with
       | 1 ->
           if _t459 = Protocol.T_STRING then
             _str458#set_file_path iprot#readString
           else iprot#skip _t459
       | 2 ->
           if _t459 = Protocol.T_I64 then _str458#set_file_offset iprot#readI64
           else iprot#skip _t459
       | 3 ->
           if _t459 = Protocol.T_STRUCT then
             _str458#set_meta_data (read_columnMetaData iprot)
           else iprot#skip _t459
       | 4 ->
           if _t459 = Protocol.T_I64 then
             _str458#set_offset_index_offset iprot#readI64
           else iprot#skip _t459
       | 5 ->
           if _t459 = Protocol.T_I32 then
...
class rowGroup =
  object (self)
    ...
    method set_total_compressed_size _x467 =
      _total_compressed_size <- Some _x467
    ...
    method write (oprot : Protocol.t) =
      ...
      | Some _v ->
          ...
          oprot#writeListBegin (Protocol.T_STRUCT, List.length _v);
          List.iter (fun _iter471 -> _iter471#write oprot) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _total_byte_size with
      ...
      | Some _v ->
          ...
          oprot#writeListBegin (Protocol.T_STRUCT, List.length _v);
          List.iter (fun _iter472 -> _iter472#write oprot) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _file_offset with
      | None -> ()
...
let rec read_rowGroup (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t474 = Protocol.T_STOP then raise Break else ();
       (match _id475 with
       | 1 ->
           if _t474 = Protocol.T_LIST then
             _str473#set_columns
               (let _etype479, _size476 = iprot#readListBegin in
                let _con480 =
                  Array.to_list
                    (Array.init _size476 (fun _ -> read_columnChunk iprot))
                in
                iprot#readListEnd;
                _con480)
           else iprot#skip _t474
       | 2 ->
           if _t474 = Protocol.T_I64 then
             _str473#set_total_byte_size iprot#readI64
           else iprot#skip _t474
       | 3 ->
           if _t474 = Protocol.T_I64 then _str473#set_num_rows iprot#readI64
           else iprot#skip _t474
       | 4 ->
           if _t474 = Protocol.T_LIST then
             _str473#set_sorting_columns
               (let _etype484, _size481 = iprot#readListBegin in
                let _con485 =
                  Array.to_list
                    (Array.init _size481 (fun _ -> read_sortingColumn iprot))
                in
                iprot#readListEnd;
                _con485)
           else iprot#skip _t474
       | 5 ->
           if _t474 = Protocol.T_I64 then _str473#set_file_offset iprot#readI64
           else iprot#skip _t474
       | 6 ->
           if _t474 = Protocol.T_I64 then
       ...
       | 7 ->
           if _t474 = Protocol.T_I16 then _str473#set_ordinal iprot#readI16
           else iprot#skip _t474
       | _ -> iprot#skip _t474);
       iprot#readFieldEnd
     done;
...
let rec read_typeDefinedOrder (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t490 = Protocol.T_STOP then raise Break else ();
       (match _id491 with _ -> iprot#skip _t490);
       iprot#readFieldEnd
     done;
     ()
   with Break -> ());
...
let rec read_columnOrder (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t497 = Protocol.T_STOP then raise Break else ();
       (match _id498 with
       | 1 ->
           if _t497 = Protocol.T_STRUCT then
             _str496#set_tYPE_ORDER (read_typeDefinedOrder iprot)
           else iprot#skip _t497
       | _ -> iprot#skip _t497);
       iprot#readFieldEnd
     done;
     ()
...
let rec read_pageLocation (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t506 = Protocol.T_STOP then raise Break else ();
       (match _id507 with
       | 1 ->
           if _t506 = Protocol.T_I64 then _str505#set_offset iprot#readI64
           else iprot#skip _t506
       | 2 ->
           if _t506 = Protocol.T_I32 then
             _str505#set_compressed_page_size iprot#readI32
           else iprot#skip _t506
       | 3 ->
           if _t506 = Protocol.T_I64 then
...
class offsetIndex =
  object (self)
    ...
    method grab_unencoded_byte_array_data_bytes =
      match _unencoded_byte_array_data_bytes with
      | None ->
          raise (Field_empty "offsetIndex.unencoded_byte_array_data_bytes")
      | Some _x510 -> _x510

    method set_unencoded_byte_array_data_bytes _x510 =
      _unencoded_byte_array_data_bytes <- Some _x510
    ...
    method write (oprot : Protocol.t) =
      ...
      | Some _v ->
          ...
          oprot#writeListBegin (Protocol.T_STRUCT, List.length _v);
          List.iter (fun _iter513 -> _iter513#write oprot) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _unencoded_byte_array_data_bytes with
      | None -> ()
      | Some _v ->
          oprot#writeFieldBegin
            ("unencoded_byte_array_data_bytes", Protocol.T_LIST, 2);
          oprot#writeListBegin (Protocol.T_I64, List.length _v);
          List.iter (fun _iter514 -> oprot#writeI64 _iter514) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      oprot#writeFieldStop;
      oprot#writeStructEnd
...
let rec read_offsetIndex (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t516 = Protocol.T_STOP then raise Break else ();
       (match _id517 with
       | 1 ->
           if _t516 = Protocol.T_LIST then
             _str515#set_page_locations
               (let _etype521, _size518 = iprot#readListBegin in
                let _con522 =
                  Array.to_list
                    (Array.init _size518 (fun _ -> read_pageLocation iprot))
                in
                iprot#readListEnd;
                _con522)
           else iprot#skip _t516
       | 2 ->
           if _t516 = Protocol.T_LIST then
             _str515#set_unencoded_byte_array_data_bytes
               (let _etype526, _size523 = iprot#readListBegin in
                let _con527 =
                  Array.to_list (Array.init _size523 (fun _ -> iprot#readI64))
                in
                iprot#readListEnd;
                _con527)
           else iprot#skip _t516
...
class columnIndex =
  object (self)
    ...
    method grab_repetition_level_histograms =
      match _repetition_level_histograms with
      | None -> raise (Field_empty "columnIndex.repetition_level_histograms")
      | Some _x534 -> _x534

    method set_repetition_level_histograms _x534 =
      _repetition_level_histograms <- Some _x534

    method unset_repetition_level_histograms =
      _repetition_level_histograms <- None

    method reset_repetition_level_histograms =
      _repetition_level_histograms <- None
    ...
    method grab_definition_level_histograms =
      match _definition_level_histograms with
      | None -> raise (Field_empty "columnIndex.definition_level_histograms")
      | Some _x535 -> _x535

    method set_definition_level_histograms _x535 =
      _definition_level_histograms <- Some _x535

    method unset_definition_level_histograms =
      _definition_level_histograms <- None

    method reset_definition_level_histograms =
      _definition_level_histograms <- None
    ...
    method write (oprot : Protocol.t) =
      ...
      | Some _v ->
          ...
          List.iter (fun _iter538 -> oprot#writeBool _iter538) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _min_values with
      ...
      | Some _v ->
          ...
          oprot#writeListBegin (Protocol.T_STRING, List.length _v);
          List.iter (fun _iter539 -> oprot#writeString _iter539) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _max_values with
      ...
      | Some _v ->
          ...
          oprot#writeListBegin (Protocol.T_STRING, List.length _v);
          List.iter (fun _iter540 -> oprot#writeString _iter540) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _boundary_order with
      ...
      | Some _v ->
          ...
          oprot#writeListBegin (Protocol.T_I64, List.length _v);
          List.iter (fun _iter541 -> oprot#writeI64 _iter541) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _repetition_level_histograms with
      | None -> ()
      | Some _v ->
          oprot#writeFieldBegin
            ("repetition_level_histograms", Protocol.T_LIST, 6);
          oprot#writeListBegin (Protocol.T_I64, List.length _v);
          List.iter (fun _iter542 -> oprot#writeI64 _iter542) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _definition_level_histograms with
      | None -> ()
      | Some _v ->
          oprot#writeFieldBegin
            ("definition_level_histograms", Protocol.T_LIST, 7);
          oprot#writeListBegin (Protocol.T_I64, List.length _v);
          List.iter (fun _iter543 -> oprot#writeI64 _iter543) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      oprot#writeFieldStop;
      oprot#writeStructEnd
...
let rec read_columnIndex (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t545 = Protocol.T_STOP then raise Break else ();
       (match _id546 with
       | 1 ->
           if _t545 = Protocol.T_LIST then
             _str544#set_null_pages
               (let _etype550, _size547 = iprot#readListBegin in
                let _con551 =
                  Array.to_list (Array.init _size547 (fun _ -> iprot#readBool))
                in
                iprot#readListEnd;
                _con551)
           else iprot#skip _t545
       | 2 ->
           if _t545 = Protocol.T_LIST then
             _str544#set_min_values
               (let _etype555, _size552 = iprot#readListBegin in
                let _con556 =
                  Array.to_list
                    (Array.init _size552 (fun _ -> iprot#readString))
                in
                iprot#readListEnd;
                _con556)
           else iprot#skip _t545
           ...
           if _t545 = Protocol.T_LIST then
             _str544#set_max_values
               (let _etype560, _size557 = iprot#readListBegin in
                let _con561 =
                  Array.to_list
                    (Array.init _size557 (fun _ -> iprot#readString))
                in
                iprot#readListEnd;
                _con561)
           else iprot#skip _t545
       | 4 ->
           if _t545 = Protocol.T_I32 then
           ...
           if _t545 = Protocol.T_LIST then
             _str544#set_null_counts
               (let _etype565, _size562 = iprot#readListBegin in
                let _con566 =
                  Array.to_list (Array.init _size562 (fun _ -> iprot#readI64))
                in
                iprot#readListEnd;
                _con566)
           else iprot#skip _t545
           ...
           if _t545 = Protocol.T_LIST then
             _str544#set_repetition_level_histograms
               (let _etype570, _size567 = iprot#readListBegin in
                let _con571 =
                  Array.to_list (Array.init _size567 (fun _ -> iprot#readI64))
                in
                iprot#readListEnd;
                _con571)
           else iprot#skip _t545
           ...
           if _t545 = Protocol.T_LIST then
             _str544#set_definition_level_histograms
               (let _etype575, _size572 = iprot#readListBegin in
                let _con576 =
                  Array.to_list (Array.init _size572 (fun _ -> iprot#readI64))
                in
                iprot#readListEnd;
                _con576)
           else iprot#skip _t545
...
let rec read_aesGcmV1 (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t584 = Protocol.T_STOP then raise Break else ();
       (match _id585 with
       | 1 ->
           if _t584 = Protocol.T_STRING then
             _str583#set_aad_prefix iprot#readString
           else iprot#skip _t584
       | 2 ->
           if _t584 = Protocol.T_STRING then
             _str583#set_aad_file_unique iprot#readString
           else iprot#skip _t584
       | 3 ->
           if _t584 = Protocol.T_BOOL then
...
let rec read_aesGcmCtrV1 (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t593 = Protocol.T_STOP then raise Break else ();
       (match _id594 with
       | 1 ->
           if _t593 = Protocol.T_STRING then
             _str592#set_aad_prefix iprot#readString
           else iprot#skip _t593
       | 2 ->
           if _t593 = Protocol.T_STRING then
             _str592#set_aad_file_unique iprot#readString
           else iprot#skip _t593
       | 3 ->
           if _t593 = Protocol.T_BOOL then
...
let rec read_encryptionAlgorithm (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t601 = Protocol.T_STOP then raise Break else ();
       (match _id602 with
       | 1 ->
           if _t601 = Protocol.T_STRUCT then
             _str600#set_aES_GCM_V1 (read_aesGcmV1 iprot)
           else iprot#skip _t601
       | 2 ->
           if _t601 = Protocol.T_STRUCT then
...
class fileMetaData =
  object (self)
    ...
    method set_footer_signing_key_metadata _x612 =
      _footer_signing_key_metadata <- Some _x612
    ...
    method write (oprot : Protocol.t) =
      ...
      | Some _v ->
          ...
          oprot#writeListBegin (Protocol.T_STRUCT, List.length _v);
          List.iter (fun _iter615 -> _iter615#write oprot) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _num_rows with
      ...
      | Some _v ->
          ...
          oprot#writeListBegin (Protocol.T_STRUCT, List.length _v);
          List.iter (fun _iter616 -> _iter616#write oprot) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _key_value_metadata with
      | None -> ()
      | Some _v ->
          ...
          oprot#writeListBegin (Protocol.T_STRUCT, List.length _v);
          List.iter (fun _iter617 -> _iter617#write oprot) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _created_by with
      | None -> ()
      ...
      | Some _v ->
          ...
          oprot#writeListBegin (Protocol.T_STRUCT, List.length _v);
          List.iter (fun _iter618 -> _iter618#write oprot) _v;
          oprot#writeListEnd;
          oprot#writeFieldEnd);
      (match _encryption_algorithm with
      | None -> ()
...
let rec read_fileMetaData (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t620 = Protocol.T_STOP then raise Break else ();
       (match _id621 with
       | 1 ->
           if _t620 = Protocol.T_I32 then _str619#set_version iprot#readI32
           else iprot#skip _t620
       | 2 ->
           if _t620 = Protocol.T_LIST then
             _str619#set_schema
               (let _etype625, _size622 = iprot#readListBegin in
                let _con626 =
                  Array.to_list
                    (Array.init _size622 (fun _ -> read_schemaElement iprot))
                in
                iprot#readListEnd;
                _con626)
           else iprot#skip _t620
       | 3 ->
           if _t620 = Protocol.T_I64 then _str619#set_num_rows iprot#readI64
           else iprot#skip _t620
       | 4 ->
           if _t620 = Protocol.T_LIST then
             _str619#set_row_groups
               (let _etype630, _size627 = iprot#readListBegin in
                let _con631 =
                  Array.to_list
                    (Array.init _size627 (fun _ -> read_rowGroup iprot))
                in
                iprot#readListEnd;
                _con631)
           else iprot#skip _t620
           ...
           if _t620 = Protocol.T_LIST then
             _str619#set_key_value_metadata
               (let _etype635, _size632 = iprot#readListBegin in
                let _con636 =
                  Array.to_list
                    (Array.init _size632 (fun _ -> read_keyValue iprot))
                in
                iprot#readListEnd;
                _con636)
           else iprot#skip _t620
       | 6 ->
           if _t620 = Protocol.T_STRING then
           ...
           if _t620 = Protocol.T_LIST then
             _str619#set_column_orders
               (let _etype640, _size637 = iprot#readListBegin in
                let _con641 =
                  Array.to_list
                    (Array.init _size637 (fun _ -> read_columnOrder iprot))
                in
                iprot#readListEnd;
                _con641)
           else iprot#skip _t620
       | 8 ->
           if _t620 = Protocol.T_STRUCT then
...
let rec read_fileCryptoMetaData (iprot : Protocol.t) =
  ...
  (try
     while true do
       ...
       if _t648 = Protocol.T_STOP then raise Break else ();
       (match _id649 with
       | 1 ->
           if _t648 = Protocol.T_STRUCT then
             _str647#set_encryption_algorithm (read_encryptionAlgorithm iprot)
           else iprot#skip _t648
       | 2 ->
           if _t648 = Protocol.T_STRING then
